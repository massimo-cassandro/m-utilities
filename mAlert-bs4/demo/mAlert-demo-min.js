	  ...
	  return  new Promise(function(resolve) {
	    jquery(modal).modal({
	      ...
	      .on('shown.bs.modal', function () {
	        let _modal = jquery(this);
	        jquery('.modal-footer button', _modal).eq(0).focus();
	        ...
	        // OK
	        jquery('.modal-footer button.mAlert-ok', _modal).on('click', function() {
	          resolve(true);
	        });

	        //Cancel
	        jquery('.modal-footer button.mAlert-cancel', _modal).on('click', function() {
	          resolve(false);
	        });
