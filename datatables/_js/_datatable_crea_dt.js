/* globals moment,  Mustache, JSutils, datatable_setup */
// exported
  ...
  */
  $.fn.creaDataTable=function (options) {
    ...
    .append(
      ...
      '<thead><tr>' + new Array(table_cells_length + 1).join('<th></th>') + '</tr></thead>'+
          ...
          case 'tpl':  // mustache template
            ...
            item.data = function (row) {
              ...
              /*
                ...
                dove filtro è uno tra striptags, nl2br ecc...
...
*/
        ...
        if(item.data && !item.name === undefined) {
          item.name = item.data;
        }
