...
function run_autoDataTable( $container, cdt_options, jquery_url) {
  ...
  if($container.length) {
    $container.each(function(){
      ...
      */
      ...
      this_datatable = _creaDataTable(_this_container, cdt_options, jquery_url);
...
export  function _autoDataTable( $container = '.dt-container', cdt_options = {}, jquery_url='https://code.jquery.com/jquery-3.6.0.min.js' ) {
  ...
  if(window.jQuery === undefined && !document.head.querySelector(`script[src="${jquery_url}"]`)) {
    ...
    script.onload = function() {
      run_autoDataTable($container, cdt_options, jquery_url);
    };
