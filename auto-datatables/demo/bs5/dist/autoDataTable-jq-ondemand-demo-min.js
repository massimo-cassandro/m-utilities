(function () {
	...
	var dataTables_bootstrap5 = {exports: {}};
	...
	var dt = jquery_dataTables.exports;
	...
	}(dataTables_bootstrap5));

	var dt_bs = dataTables_bootstrap5.exports;
	...
	*/
	...
	function creaDT( $container, options = {}, dt_bs, dt_config_bs) {
	...
	function jquery_loader (jquery_url='https://code.jquery.com/jquery-3.6.0.min.js', callback) {
	  try {
	...
	function _creaDataTable( $container, options = {}, jquery_url='https://code.jquery.com/jquery-3.6.0.min.js') {

	  return jquery_loader(jquery_url, () => {
	    return creaDT($container, options, dt_bs, dt_config_bs5);
	  });
	}
	...
	function number_format (number, decimals, force_plus) {
	...
	*/
	...
	function autoDT( $container = '.dt-container', cdt_options = {}, _creaDataTable ) {
	...
	function _autoDataTable( $container = '.dt-container', cdt_options = {}, jquery_url='https://code.jquery.com/jquery-3.6.0.min.js' ) {
	  return jquery_loader(jquery_url, () => {
...
//# sourceMappingURL=autoDataTable-jq-ondemand-demo-min.js.map
